...
const sendData = async (arrayToSend) => {
  ...
  const Beta1 = async (str) => {
    try {
      const response = await axios.post('http://127.0.0.1:5000/bet1', {
        string:str,
      });
      console.log('String sent successfully');
      console.log(response.data)
      Betares=response.data
      return Betares
    } catch (error) {
...
// Remove word "KEY" from below or use new API key
//OPENAI_API_KEY='KEYsk-KPCXmxuBe4HgVNE0uyQWTKEY3BlbkFJTTUk6z1kszCFaSPxat8pKEY';
